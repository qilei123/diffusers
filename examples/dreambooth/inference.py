...
def inference_repaint():
    model_id = "/home/qilei/DEVELOPMENT/diffusers/examples/dreambooth/output/DreamBoothDataset4Med_inpaint_crop1_mask1_bbox1.1_db2x10"
    ...
    original_image,mask = load_test_data(img_id,with_crop=True,bbox_extend=1.1)
    size = 512
